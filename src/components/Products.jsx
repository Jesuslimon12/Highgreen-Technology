...
export default function Products() {
  ...
  return (
    <div id='products' className='main_products'>
      ...
      <div className='items_product_container'>
        <h1 className='highlighted_text'>SWEEPERS</h1>
      ...
      <div className='items_product_container'>
        <h1 className='highlighted_text'>DRYERS</h1>
        <Item_Product name={'HAAGA 477 Sweeper'} description={description} />

      </div>

      <div className='items_product_container'>
        <h1 className='highlighted_text'>CLEANERS</h1>
        <Item_Product name={'HAAGA 477 Sweeper'} description={description} />
      </div>
